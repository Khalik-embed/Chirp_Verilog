...
REM
REM Generated by Vivado on Sat Feb 05 16:22:07 +0300 2022
...
echo "xvlog --incr --relax -prj Test_cordic_vlog.prj"
call xvlog  --incr --relax -prj Test_cordic_vlog.prj -log xvlog.log
