...
REM
REM Generated by Vivado on Sun Feb 06 04:08:03 +0300 2022
...
echo "xvlog --incr --relax -prj Test_modulator_vlog.prj"
call xvlog  --incr --relax -prj Test_modulator_vlog.prj -log xvlog.log
