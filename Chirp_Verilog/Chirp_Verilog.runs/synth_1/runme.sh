...
HD_PWD='C:/Project/Chirp_Verilog/Chirp_Verilog/Chirp_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_modulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_modulator.tcl
